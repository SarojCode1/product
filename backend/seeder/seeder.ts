...
const setProducts = async () => {
    try {
                ...
                images: [
                    {
                        ...
                        url: 'https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T1/images/I/617NtexaW2L.jpg'
                    }
                ],
                ...
                images: [
                    {
                        ...
                        url: 'https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T1/images/I/61oXGZ60GfL._SL1215_.jpg'
                    }
                ],
                category: 'Electronics',
                seller: 'Amazon',
                ...
                images: [
                    {
                        ...
                        url: 'https://m.media-amazon.com/images/I/61VD7JR9I9L._SL1500_.jpg'
                    }
                ],
                category: 'Electronics',
                seller: 'Amazon',
                ...
                images: [
                    {
                        ...
                        url: 'https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T1/images/I/81+jNVOUsJL.jpg'
                    }
                ],
                category: 'Headphones',
                seller: 'Amazon',
                ...
                images: [
                    {
                        ...
                        url: 'https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T1/images/I/71djnhmfy-L._AC_SL1500_.jpg'
                    }
                ],
                category: 'Electronics',
                seller: 'Amazon',
                ...
                images: [
                    {
                        ...
                        url: 'https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T1/images/I/81WoPGs-pXL.jpg'
                    }
                ],
                ...
                images: [
                    {
                        ...
                        url: 'https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T1/images/I/71TSinb4usL.jpg'
                    }
                ],
                category: 'Cameras',
                seller: 'Amazon',
                ...
                images: [
                    {
                        ...
                        url: 'https://www.laptopsdirect.co.uk/Images/MLXW3BA_4_Supersize.jpg?v=3'
                    }
                ],
                category: 'Laptops',
                seller: 'Amazon',
                ...
                images: [
                    {
                        ...
                        url: 'https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T1/images/I/4147jUEfy9L.jpg'
                    },
                    {
        ...
        console.log('All products are inserted in database!');
    } catch (error) {
        console.log(error);
